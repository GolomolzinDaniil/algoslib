...
from algoslib.sorting.sub_sorting import bubble_sort, selection_sort, gnome_sort, insertion_sort, quick_sort


ALGORITHMS = [bubble_sort, selection_sort, gnome_sort, insertion_sort, quick_sort]
